...
// import { SendLoginOtp, RegisterStudent } from 'src/actions/auth';
...
//     phoneNumber: Yup.string().max(9).notRequired(),
//     guardianPhoneNumber: Yup.string().when('learningPreference', {
//       is: 'Curricula',
//       then: (schema) =>
//         schema.required(t('Global.Validation.parent_phone_required')).min(6).max(9),
...
//         // console.log('Countries API Full Response:', res);
...
//     console.log(JSON.stringify(registrationRes, null, 2));
...
//       console.log('Registration Error Details:', registrationRes.error);
...
//       console.log('OTP Response Error Details:', otpRes.error);
//       setConfirm(null); // Close the OTP dialog
//       return;
//     }
...
//     // console.log('Phone with country code:', '+966' + data.phoneNumber);
//     // console.log('Guardian phone with country code:', '+966' + data.guardianPhoneNumber);
//     // console.log('Learning Preference:', data.learningPreference);
//   });
