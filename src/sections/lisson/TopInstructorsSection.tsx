...
import InstructorCard from '../landing/top-instructor/InstructorCard';
...
export default function InstructorsSections() {
  return (
    // Set background to white (default Box behavior)
    <Box sx={{ py: { xs: 8, md: 10 }, px: { xs: 2, md: 3 }, direction: 'rtl' }}>
      {/* 2. Instructors Grid */}
