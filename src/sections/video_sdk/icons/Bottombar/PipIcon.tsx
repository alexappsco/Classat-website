...
type IconProps = React.SVGProps<SVGSVGElement> & { fillcolor?: string };

const PipIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 96 960 960" fill="none" {...props}>
    <path
