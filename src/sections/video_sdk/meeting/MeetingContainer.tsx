...
export function MeetingContainer({
  ...
  // إذا كانت السبورة مفعلة، لا تعتبرها مشاركة شاشة لتفادي التعارض
  const isPresenting = !!mMeeting.presenterId && !sdkWhiteboardUrl;
              ...
              <Box sx={{ display: 'flex', height: '85%', flex: 1, flexDirection: 'row', bgcolor: '#1a1c23' }}>
                ...
                {isPresenting ? (
                  <>
                    ...
                    >
                      <MemorizedParticipantView isPresenting={isPresenting as any} />
                    </Box>
